...
/* ──────────────────────────────────────────────────────────────
  i18n + robust match (HU/EN/DE)
────────────────────────────────────────────────────────────── */

const COPY = {
    hu: { bookingFallback: "Időpontfoglalás" },
    en: { bookingFallback: "Book an appointment" },
    de: { bookingFallback: "Termin buchen" },
} as const;
    ...
    return (
        <div className="flex items-center justify-center gap-2 py-2">
            {Array.from({ length: count }).map((_, i) => (
                ...
                >
                    <span className={cn("block h-2 rounded-full transition-all", i === active ? "w-6 bg-neutral-900" : "w-2 bg-neutral-300")} />
                </button>
            ))}
        </div>
    );
    ...
    return (
        <div className="fixed inset-0 z-[80]" role="dialog" aria-modal="true">
            ...
            <div className="absolute inset-0 flex items-center justify-center p-3 sm:p-4 md:p-8">
                <div className={cn("relative w-full max-w-7xl", tok.modal, "max-h-[92dvh] overflow-hidden")}>
                    <button
                        ref={closeBtnRef}
                        type="button"
                        onClick={onClose}
                        ...
                        <div className="px-6 sm:px-8 lg:px-10 pb-10 pt-6">
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
                                ...
                                <div className="lg:col-span-7">
                                    ...
                                    >
                                        <div className="relative w-full h-[280px] sm:h-[360px] lg:h-[520px] group">
                                            {mainUrl ? (
                                                <motion.div
                                                    ...
                                                    onDragEnd={(_, info) => {
                                                        ...
                                                        if (info.offset.x > SWIPE_THRESHOLD) prevMedia();
                                                        if (info.offset.x < -SWIPE_THRESHOLD) nextMedia();
                                                    }}
                                                >
                                                    <StrapiImage
                                                        alt={team.name || "Team"}
                                            ...
                                            {mediaUrls.length > 1 && (
                                                <>
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "absolute left-3 top-1/2 -translate-y-1/2 z-20 grid h-9 w-9 place-items-center rounded-full",
                                                    ...
                                                    >
                                                        <IconChevronLeft className="h-4 w-4 text-neutral-900/75" />
                                                    </button>
                                                    ...
                                                    <button
                                                        ...
                                                        title="Next image"
                                                        className={cn(
                                                            "absolute right-3 top-1/2 -translate-y-1/2 z-20 grid h-9 w-9 place-items-center rounded-full",
                                                            "bg-white/18 backdrop-blur-2xl border border-white/35",
                                                            "shadow-[0_8px_24px_rgba(0,0,0,0.10)]",
                                                            "hover:bg-white/28 transition active:scale-95",
                                                            "opacity-100 lg:opacity-0 lg:group-hover:opacity-100"
                                                    ...
                                                    >
                                                        <IconChevronRight className="h-4 w-4 text-neutral-900/75" />
                                                    </button>
                                                </>
                                            )}
                                        </div>
                                ...
                                <div className="lg:col-span-5">
                                    <div className="rounded-2xl bg-neutral-50/60 border border-neutral-200/60 p-5 md:p-6">
                                        ...
                                        >
                                            <div className="text-xl font-semibold text-neutral-800 py-4">{team.heading}</div>
                                            {bodyText}
                                        </div>
                                    </div>
                                </div>
