...
/** URL feloldás: string vagy nyelvi objektum → működő URL */
function resolveReviewUrl(
  ...
  // 1) aktuális nyelvhez megadott URL
  const exact = byLocale[locale];
  if (exact) return exact;

  // 2) első nem üres URL az objektumból
...
export const Testimonials = ({
  ...
  locale?: Locale;
  /** String vagy nyelvenkénti URL-ek */
  googleReviewUrl?: UrlByLocale;
}) => {
  // Nyelv meghatározása – ha nincs prop, böngésző alapján (kliensen fut)
  ...
  return (
    ...
    <div className="relative bg-white">
      ...
      <div className="pb-16 text-center">
        ...
        {/* Lokalizált Google értékelés gomb */}
  ...
  <a
    ...
    className={[
      ...
      // 👉 mobilon teljes szélesség + max. 22rem, nagyobb képernyőn auto
      "w-full max-w-[22rem] sm:w-auto sm:max-w-none",
      // 👉 több soros tördelés + középre zárás
  ...
  >
    ...
    {/* ❗ több sorban is szép legyen a sormagasság */}
    <span className="leading-tight text-center text-pretty">
      ...
      {/* Tartalom: slider + elválasztó + marquee — csak ha van adat */}
