...
export function Featured({
  ...
  const slideBg = useMemo(
    () => [
      ...
      "bg-gradient-to-tl from-white via-breaker-bay-50 to-white",
            ...
            <div className="bb-slide-inner w-full h-full overflow-hidden">
              <div className="bb-slide-content absolute inset-0 flex items-start justify-center">
                ...
                >
                  ...
                  <h2 className="bb-heading col-span-12 row-start-1 row-end-2 self-end text-[clamp(1.35rem,5vw,3.25rem)] font-black text-breaker-bay-950 tracking-tight">
                    {p.name}
                  </h2>
